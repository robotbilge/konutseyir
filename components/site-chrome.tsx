...
const navItems = [["Konut Analizi", "/ev-analizi"], ["Karşılaştır", "/karsilastir"], ["Şehirler", "/sehirler"], ["Haberler", "/haberler"], ["Kontrol Listesi", "/kontrol-listesi"], ["Rehber", "/rehber"], ["Veri", "/veri"]];
...
export function Footer(){return <footer className="site-footer"><div className="footer-main"><div><a className="brand footer-brand" href="/"><span><Building2 size={18}/></span><span>Konut<b>Seyir</b></span></a><p>Konut kararlarını kira, maliyet, enflasyon ve alternatif getirilerle birlikte değerlendirin.</p><a className="footer-email" href="mailto:iletisim@konutseyir.com">iletisim@konutseyir.com</a></div><div className="footer-nav"><div><strong>Araçlar</strong><a href="/ev-analizi">Konut analizi</a><a href="/kredi-hesaplama">Kredi hesaplama</a><a href="/karsilastir">Yatırım karşılaştırma</a><a href="/hesaplama/kira-artis-orani">Kira artış oranı</a><a href="/hesaplama/tapu-harci">Tapu harcı</a><a href="/hesaplama/altin-bazli-konut">Altın bazlı konut</a><a href="/kontrol-listesi">Alım kontrol listesi</a></div><div><strong>Bilgi</strong><a href="/rehber">Rehberler</a><a href="/sehirler">Şehir sayfaları</a><a href="/resmi-kontroller">Resmî kontroller</a><a href="/veri">Veri kaynakları</a></div><div><strong>KonutSeyir</strong><a href="/hakkimizda">Hakkımızda</a><a href="/yayin-ilkeleri">Yayın ilkeleri</a><a href="/iletisim">İletişim</a><a href="/gizlilik">Gizlilik</a><a href="/cerez-politikasi">Çerez politikası</a><a href="/kullanim-kosullari">Kullanım koşulları</a></div></div></div><div className="footer-bottom"><small>© 2026 KonutSeyir</small><span>Bağımsız karar destek platformu · Yatırım tavsiyesi değildir. · Kardeş proje: <a href="https://altinseyir.com/" target="_blank" rel="noreferrer">AltınSeyir.com</a></span></div></footer>}
